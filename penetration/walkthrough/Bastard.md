...
![0.9](https://mxrblog.cn/main/0.9.png)

- nmap进行更细致的扫描

![1](https://mxrblog.cn/main/1.png)

- nmap扫描是否存在漏洞

![2](https://mxrblog.cn/main/2.png)
...
![0.1](https://mxrblog.cn/main/0.1.png)
...
![0.15](https://mxrblog.cn/main/0.15.png)

- 我们发现了许多文件，其中CHAGELOG.txt文件中有这CMS的版本信息，我们可以查看到

![0.2](https://mxrblog.cn/main/0.2.png)
...
![3.9](https://mxrblog.cn/main/3.9.png)
...
![4](https://mxrblog.cn/main/4.png)

![5](https://mxrblog.cn/main/5.png)

![4.5](https://mxrblog.cn/main/4.5.png)

- 我们得到了一个shell，这是我在参考了许多walkthrough后得到的最快捷的方式

- 查看系统信息

![6](https://mxrblog.cn/main/6.png)
...
![7](https://mxrblog.cn/main/7.png)

- 在windows靶机中接收脚本文件

![8](https://mxrblog.cn/main/8.png)
